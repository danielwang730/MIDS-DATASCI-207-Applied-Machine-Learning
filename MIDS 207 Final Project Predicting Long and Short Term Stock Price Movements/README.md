# DATASCI 207 Final Project - Daniel Wang
...
While you can skip directly to the [final evaluation here](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/06%20Final%20Model%20Evaluation/01_Final_Model_Evaluation.ipynb), it took substantial trial and error to reach this point. Below is a guide highlighting the most important notebooks and key sections to review. While this file summarizes the overall outcomes, **the notebooks themselves contain more detailed commentary and capture the reasoning behind my decisions at each step**. Lastly, you're welcome to explore the archived/original notebooks as well, though many of them contain exploratory or supplementary work that's not essential for understanding the main progression of my work.

### Step 0: Data Preprocessing & Feature Engineering

Our project begins in this [data preprocessing notebook](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/00%20Data%20Processing%20and%20Feature%20Engineering/00_Data_Preprocessing.ipynb), where we downloaded and cleaned our dataset.

Next, we performed some [initial data visualizations](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/00%20Data%20Processing%20and%20Feature%20Engineering/01_Data_Visualization.ipynb). However, visualizations based on raw stock prices proved to be less insightful due to the inherent variability across different tickers.

Lastly, we constructed derived features from the raw price and volume data in our [feature engineering notebook](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/00%20Data%20Processing%20and%20Feature%20Engineering/02_Feature_Engineering.ipynb), and explained our reasoning for selecting specific technical indicators.
...
### Step 1: [No Time Series Baseline Models](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/01%20Baseline%20Models/00_No_Time_Series_Baseline_Models.ipynb)
...
### Step 2: [Time Series Rolling Window Models (w/ Rolling OHLCV Values as Features)](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/01%20Baseline%20Models/01_Time_Series_Baseline_Models.ipynb)
...
### Step 3: [LSTM Models Using 80/20 Train/Test Split](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/02%20Improved%20Models%20(with%20Normalization%20to%20Open)/00_LSTM_Models_80_20_Split.ipynb)
...
### Step 4: [LSTM Models Using 99/1 Train/Test Split](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/02%20Improved%20Models%20(with%20Normalization%20to%20Open)/01_LSTM_Models_99_1_Split.ipynb)
...
### Step 5: [LSTM Models With True Sequences Using 80/20 Train/Test Split](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/03%20LSTM%20Models%20(with%20Corrected%20Sequence%20Normalization)/00_LSTM_Models_w_True_Sequences_80_20_Split.ipynb)
...
### Step 6: [LSTM Models With True Sequences Using 99/1 Train/Test Split](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/03%20LSTM%20Models%20(with%20Corrected%20Sequence%20Normalization)/01_LSTM_Models_w_True_Sequences_99_1_Split.ipynb)
...
### Step 7: [PCA-LSTM Models](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/04%20PCA%20LSTM%20Models/00_PCA_LSTM_Models.ipynb)
...
### Step 8: [LSTM Models With Sliding Windows and Even Smaller Validation and Test Sizes](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/03%20LSTM%20Models%20(with%20Corrected%20Sequence%20Normalization)/02_LSTM_Models_w_True_Sequences_Sliding_Windows.ipynb)
...
### Step 8.5: [Why the Data Splits Need Correction (Oversight #2)](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/05%20Final%20LSTM%20Models%20(with%20Corrected%20Train_Val_Test%20Data%20Splits)/00_Final_LSTM_Models_Correct_Data_Splits.ipynb)
...
### Step 9: [Final LSTM Model Testing (with Corrected Training, Validation, and Test Data Splits)](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/05%20Final%20LSTM%20Models%20(with%20Corrected%20Train_Val_Test%20Data%20Splits)/00_Final_LSTM_Models_Correct_Data_Splits.ipynb)
...
### Step 10: [Final Model Evaluation](https://github.com/aagarwal17/datasci-207-final-project/blob/Test_20250206/06%20Final%20Model%20Evaluation/01_Final_Model_Evaluation.ipynb)
